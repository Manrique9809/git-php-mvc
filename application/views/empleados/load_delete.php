    ...
    <form action="<?php echo BASE_URL . $controlador . '/action_delete' ?>" method="post">
            ...
            <fieldset>
                ...
                <div class="col-md-4">
                    ...
                    <select name="sexo" id="sexo" class="form-control" disabled>
                        <option value=""><?php echo $item_empleados->sexo; ?></option>
                        <option value="">--Seleccione--</option>
                ...
                <div class="col-md-4">
                    ...
                    <input value="<?php echo $item_empleados->f_nac; ?>" type="date" class="form-control" id="fecha" name="f_nac" disabled>
                </div>

                <div class="col-md-4">
                    <p>Estado Civil</p>
                    <select name="est_civil" id="est_civil" class="form-control" disabled>
                    <option value=""><?php echo $item_empleados->est_civil; ?></option>
                        <option value="">--Seleccione--</option>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <option value=""><?php echo $item_empleados->id_departamento; ?></option>
                    <option value="">--Seleccione--</option> 
                    <?php
            ...
            <div class="col-md-4">
                ...
                <option value=""><?php echo $item_empleados->id_provincia; ?></option>
                    <option value="">--Seleccione--</option> 
                    <?php
            ...
            <div class="col-md-4">
                ...
                <option value=""><?php echo $item_empleados->id_distrito; ?></option>
                    <option value="">--Seleccione--</option> 
                    <?php
