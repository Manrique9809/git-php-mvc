...
class Empleados extends Controller {
    ...
    function load_add() {
        ...
        $_items_profesion = $_info_paises->get_profesion();
        $_items_departamento = $_info_paises->get_departamentos();
        $_items_distrito= $_info_paises->get_distritos();
        $_items_tipousu= $_info_paises->get_tipousu();
    ...
    function load_update($id) {
     ...
     function load_delete($id) {
      ...
      //var_dump( $_item_empleados);
        ...
        $_items_provincias= $_info_paises->get_provincias();
        $_items_distrito= $_info_paises->get_distritos();
